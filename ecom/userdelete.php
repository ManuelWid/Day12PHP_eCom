...
if ($_POST) {
    ...
    if ($connect->query($sql) === TRUE) {
        ...
        $message = "Successfully Deleted! <br/> You will be redirected in 3 seconds.";
...
<body>
    ...
    <fieldset>
        ...
        <form method="post">
            ...
            <a href="adminpanel.php"><button class="btn btn-warning" type="button">No, go back!</button></a>
        </form>
    </fieldset>
</body>
</html>