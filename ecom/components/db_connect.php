<?php
    ...
    $hostname = "localhost"; // online: 173.212.235.205 , local: localhost
    $username = "root"; // online: widnerco_admin , local: root
    $password = ""; // online: !CodeFactory2022 , local: ""
    $dbname = "ecom"; // online: widnerco_ecom , local: ecom
